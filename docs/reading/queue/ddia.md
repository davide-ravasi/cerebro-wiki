...
| 10 | **In corso** — raw `chapter-10.md` aperto 22/09 (Batch and Stream Processing) |
...
- **2026-09-22** — Cap. 10: raw scheletro + lettura ~**6/40** pp. Next: digitare intro/Unix quando ci sono note a mano.
